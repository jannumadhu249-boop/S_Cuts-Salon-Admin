...
import logo from "../../assets/images/scut-logo.png";
            ...
            <div className="navbar-brand-box d-lg-none d-md-block">
              <Link to="/" className="logo logo-dark">
                <span className="logo-sm">
                  {/* <img src={scutslogo} alt="" height="22" /> */}
...
{/* 
            <div className="dropdown d-none d-lg-inline-block ms-1">
              ...
              >
                <i className="bx bx-calendar" /> Calendar
              </button>
            </div> */}

            <div className="dropdown d-none d-lg-inline-block ms-1">
              <Link to="/appointments" className="btn header-item noti-icon d-flex align-items-center" title="Calendar">
            ...
            <div className="dropdown d-none d-lg-inline-block ms-1">
              <Link to="/pos" className="btn header-item noti-icon d-flex align-items-center" title="Open POS">
                <i className="bx bx-cart me-2"></i>
                <span className="fs-6 fw-medium">Open POS</span>
              </Link>
            </div>  
